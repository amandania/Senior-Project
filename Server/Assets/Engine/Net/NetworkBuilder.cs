...
public class NetworkBuilder : IServerTCP
{
    ...
    public NetworkBuilder(IConnectionManager connectionManager, ChannelEventHandler channelEventHandler, IWorld world, INPCMovement npcMover)
    {
        _channelEventHandler = channelEventHandler;
        _connectionManager = connectionManager;
        _world = world;
        _world._npcMovement = npcMover;
